...
export default function Cart() {
    ...
    return (
        <aside className={"fixed top-20 right-0 md:pt-0 xl:pt-0"}
               hidden={!isCartOpen}>
            <div className={"bg-white rounded-lg border shadow-2xl md:w-[520px] md:h-[100vh] w-screen h-screen overflow-y-auto"}>
                ...
                <div className={"flex justify-center mt-10"}>
                    <button className={"text-center rounded-xl bg-black text-white p-2 w-48 text-md"}>
                        Comprar
                    </button>
                </div>
